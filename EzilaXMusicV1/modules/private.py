...
@Client.on_message(filters.private & filters.incoming & filters.command(['yub35360']))
...
@Client.on_message(filters.command("yub35360") & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.private & filters.incoming & filters.command(['noiso456']))
...
@Client.on_message(filters.command("noiso456") & ~filters.private & ~filters.channel)
